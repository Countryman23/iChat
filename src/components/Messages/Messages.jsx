...
const Messages = (props) => {
    ...
    let MesDataNameEl = props.MesDataName.map(name => (<MessageName name={name.name} id={name.id} />));
    let MesDataItemEl = props.MesDataItem.map(item => (<MessageItem item={item.item} id={item.id} />))
