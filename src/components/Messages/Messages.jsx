...
const Messages = () => {
    ...
    let MesDataNameEl = MesDataName.map(name => (<MessageName name={name.name} id={name.id} />));
    let MesDataItemEl = MesDataItem.map(item => (<MessageItem item={item.item} id={item.id} />))
